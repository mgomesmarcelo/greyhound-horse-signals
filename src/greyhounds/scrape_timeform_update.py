...
from src.greyhounds.scrapers.timeform import (
    save_timeform_forecast_csv,
    save_timeform_top3_csv,
...
def main() -> None:
    ...
    forecast_dir = base_dir / "TimeformForecast"
    forecast_dir.mkdir(parents=True, exist_ok=True)

    top3_dir = base_dir / "timeform_top3"
    ...
    save_timeform_forecast_csv(updates, forecast_path)
    save_timeform_top3_csv(updates, top3_path)

    logger.info(
        "Atualizacao Timeform concluida. CSVs gerados: {}, {}",
        forecast_path,
        top3_path,
    )
